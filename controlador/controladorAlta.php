...
if(count($errores) > 0){
    ...
    $_SESSION["insertarAsistido"] = "insert into asistido (nombre, primerApellido, segundoApellido, fNacimiento, NSS, telefono, sexo, rangoEdad, asistido.tipoBeneficiario, direccion, cp,localidad, idEstadoCivil, idProvincia, idContacto) values 
                    ('".$_REQUEST["nombre"]."',
                    '".$_REQUEST["primerApellido"]."',
                    '".$_REQUEST["segundoApellido"]."',
                    '".$_REQUEST["fNacimiento"]."',
                    ".$_REQUEST["NSS"].",
                    ".$_REQUEST["telefono"].",
                    '".$_REQUEST["sexo"]."',
                    '".$_REQUEST["rangoEdad"]."',
                    '".$_REQUEST["tipoBeneficiario"]."',
                    '".$_REQUEST["direccion"]."',
                    ".$_REQUEST["cp"].",
                    '".$_REQUEST["localidad"]."',
                    ".$_REQUEST["idEstadoCivil"].",
                    ".$_REQUEST["idProvincia"].",";
